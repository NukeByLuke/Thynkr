...
export class FileProcessorService {
  ...
  async extractText(filePath: string, mimeType: string): Promise<string> {
    ...
    try {
      ...
      if (
        ...
        normalizedMime === 'application/vnd.openxmlformats-officedocument.presentationml.slideshow' ||
  ...
  validateFileType(mimeType: string, originalName: string): boolean {
    ...
    const allowedExtensions = new Set(['.pdf', '.docx', '.doc', '.txt', '.ppt', '.pptx', '.pps', '.ppsx']);
