...
// Using Gemini 3.0 Flash for all tasks - latest model with best quality and speed
const GEMINI_PRO_MODEL = 'gemini-3.0-flash';
const GEMINI_FLASH_MODEL = 'gemini-3.0-flash';
