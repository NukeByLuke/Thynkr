...
export const ACHIEVEMENTS: Record<string, AchievementDefinition> = {
  scholar: {
    ...
    icon: '📚',
    category: 'study',
    thresholds: { BRONZE: 10, SILVER: 50, GOLD: 100, PLATINUM: 500, DIAMOND: 1000 },
    xpRewards: { BRONZE: 50, SILVER: 200, GOLD: 500, PLATINUM: 2000, DIAMOND: 5000 },
  },
  streak_master: {
    id: 'streak_master',
    name: 'Streak Master',
    ...
    icon: '🔥',
    category: 'streak',
    thresholds: { BRONZE: 3, SILVER: 7, GOLD: 14, PLATINUM: 30, DIAMOND: 100 },
    xpRewards: { BRONZE: 50, SILVER: 150, GOLD: 400, PLATINUM: 1500, DIAMOND: 4000 },
  },
  quiz_whiz: {
    id: 'quiz_whiz',
    name: 'Quiz Whiz',
    ...
    icon: '🎯',
    category: 'skill',
    thresholds: { BRONZE: 1, SILVER: 5, GOLD: 10, PLATINUM: 25, DIAMOND: 50 },
    xpRewards: { BRONZE: 50, SILVER: 200, GOLD: 450, PLATINUM: 1800, DIAMOND: 4500 },
  },
  librarian: {
    id: 'librarian',
    name: 'Librarian',
    ...
    icon: '📂',
    category: 'content',
    thresholds: { BRONZE: 5, SILVER: 20, GOLD: 50, PLATINUM: 150, DIAMOND: 500 },
    xpRewards: { BRONZE: 50, SILVER: 180, GOLD: 420, PLATINUM: 1600, DIAMOND: 4200 },
  },
  socialite: {
    id: 'socialite',
    name: 'Socialite',
    ...
    icon: '💬',
    category: 'social',
    thresholds: { BRONZE: 3, SILVER: 10, GOLD: 25, PLATINUM: 75, DIAMOND: 200 },
    xpRewards: { BRONZE: 50, SILVER: 170, GOLD: 400, PLATINUM: 1500, DIAMOND: 4000 },
  },
  speed_demon: {
    id: 'speed_demon',
    name: 'Speed Demon',
    ...
    icon: '⚡',
    category: 'skill',
    thresholds: { BRONZE: 10, SILVER: 50, GOLD: 150, PLATINUM: 500, DIAMOND: 1500 },
    xpRewards: { BRONZE: 50, SILVER: 190, GOLD: 470, PLATINUM: 1900, DIAMOND: 4700 },
  },
  note_taker: {
    id: 'note_taker',
    name: 'Note Taker',
    ...
    icon: '📝',
    category: 'content',
    thresholds: { BRONZE: 5, SILVER: 25, GOLD: 75, PLATINUM: 200, DIAMOND: 600 },
    xpRewards: { BRONZE: 50, SILVER: 180, GOLD: 440, PLATINUM: 1700, DIAMOND: 4400 },
  },
  flashcard_master: {
    id: 'flashcard_master',
    ...
    icon: '🎴',
    category: 'study',
    thresholds: { BRONZE: 3, SILVER: 15, GOLD: 40, PLATINUM: 120, DIAMOND: 350 },
    xpRewards: { BRONZE: 50, SILVER: 175, GOLD: 430, PLATINUM: 1650, DIAMOND: 4300 },
  },
  tutor_enthusiast: {
    id: 'tutor_enthusiast',
    ...
    icon: '🤖',
    category: 'study',
    thresholds: { BRONZE: 5, SILVER: 20, GOLD: 60, PLATINUM: 180, DIAMOND: 500 },
    xpRewards: { BRONZE: 50, SILVER: 185, GOLD: 450, PLATINUM: 1750, DIAMOND: 4500 },
  },
  early_bird: {
    id: 'early_bird',
    name: 'Early Bird',
    ...
    icon: '🌅',
    category: 'streak',
    thresholds: { BRONZE: 5, SILVER: 15, GOLD: 35, PLATINUM: 100, DIAMOND: 300 },
    xpRewards: { BRONZE: 50, SILVER: 165, GOLD: 410, PLATINUM: 1550, DIAMOND: 4100 },
  },
  night_owl: {
    id: 'night_owl',
    name: 'Night Owl',
  ...
  perfectionist: {
    ...
    icon: '💎',
    category: 'skill',
    thresholds: { BRONZE: 1, SILVER: 3, GOLD: 8, PLATINUM: 20, DIAMOND: 50 },
    xpRewards: { BRONZE: 50, SILVER: 220, GOLD: 520, PLATINUM: 2100, DIAMOND: 5200 },
  },
  course_creator: {
    id: 'course_creator',
    name: 'Course Creator',
    ...
    category: 'content',
    thresholds: { BRONZE: 1, SILVER: 3, GOLD: 8, PLATINUM: 20, DIAMOND: 50 },
    xpRewards: { BRONZE: 50, SILVER: 210, GOLD: 500, PLATINUM: 2000, DIAMOND: 5000 },
  },
  marathon_runner: {
    id: 'marathon_runner',
    ...
    icon: '🏃',
    category: 'study',
    thresholds: { BRONZE: 1, SILVER: 5, GOLD: 15, PLATINUM: 40, DIAMOND: 100 },
    xpRewards: { BRONZE: 50, SILVER: 195, GOLD: 480, PLATINUM: 1850, DIAMOND: 4800 },
  },
  consistent_learner: {
    ...
    icon: '📅',
    category: 'streak',
    thresholds: { BRONZE: 2, SILVER: 6, GOLD: 15, PLATINUM: 35, DIAMOND: 80 },
    xpRewards: { BRONZE: 50, SILVER: 175, GOLD: 440, PLATINUM: 1700, DIAMOND: 4400 },
  },
  game_champion: {
    id: 'game_champion',
    name: 'Game Champion',
    ...
    icon: '🏆',
    category: 'skill',
    thresholds: { BRONZE: 3, SILVER: 10, GOLD: 30, PLATINUM: 80, DIAMOND: 200 },
    xpRewards: { BRONZE: 50, SILVER: 190, GOLD: 460, PLATINUM: 1800, DIAMOND: 4600 },
  },
  knowledge_seeker: {
    id: 'knowledge_seeker',
    ...
    icon: '🔍',
    category: 'study',
    thresholds: { BRONZE: 5, SILVER: 15, GOLD: 40, PLATINUM: 100, DIAMOND: 250 },
    xpRewards: { BRONZE: 50, SILVER: 175, GOLD: 435, PLATINUM: 1700, DIAMOND: 4350 },
  },
  summary_specialist: {
    ...
    icon: '📋',
    category: 'content',
    thresholds: { BRONZE: 10, SILVER: 40, GOLD: 100, PLATINUM: 300, DIAMOND: 800 },
    xpRewards: { BRONZE: 50, SILVER: 185, GOLD: 455, PLATINUM: 1800, DIAMOND: 4550 },
  },
  community_helper: {
    id: 'community_helper',
    ...
    icon: '🤝',
    category: 'social',
    thresholds: { BRONZE: 2, SILVER: 8, GOLD: 20, PLATINUM: 50, DIAMOND: 150 },
    xpRewards: { BRONZE: 50, SILVER: 195, GOLD: 470, PLATINUM: 1850, DIAMOND: 4700 },
  },
  multilingual: {
    id: 'multilingual',
    name: 'Multilingual',
    ...
    icon: '🌍',
    category: 'skill',
    thresholds: { BRONZE: 2, SILVER: 3, GOLD: 5, PLATINUM: 8, DIAMOND: 12 },
    xpRewards: { BRONZE: 50, SILVER: 250, GOLD: 600, PLATINUM: 2400, DIAMOND: 6000 },
  },
};
