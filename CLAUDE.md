...
## 9. Key File Paths (Relative)

- **Frontend**: `./frontend/src/`
- **Backend**: `./backend/src/`
- **Components**: `./frontend/src/components/`
- **API Client**: `./frontend/src/lib/api.ts`
- **Upload Modal**: `./frontend/src/components/modals/UploadModal.tsx`
- **UI Components**: `./frontend/src/components/ui/`
- **Routes (Backend)**: `./backend/src/routes/`
- **Services (Backend)**: `./backend/src/services/`
- **Database Schema**: `./backend/prisma/schema.prisma`
- **CI/CD**: `./.github/workflows/deploy.yml`

## 10. Claude Code Workflow Guidelines

- **Tool Usage**: Always use dedicated tools (Read, Edit, Write, Grep, Glob) instead of bash commands for file operations.
- **Parallel Operations**: Make independent tool calls in parallel when possible.
- **Context**: Use relative paths starting with `./` for all file references.
- **Testing**: After making changes, verify the code compiles and follows TypeScript strict mode.
- **Documentation**: Keep code comments minimal and focused on "why" not "what".
