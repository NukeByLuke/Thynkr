...
const FlashcardViewer = memo(function FlashcardViewer({
  ...
  const handleCardAudioToggle = useCallback(() => {
    ...
    openAudioPlayer({
      ...
      title: `$<span className="text-brand-600 dark:text-brand-400">AI</span> {title || 'Flashcards'} Audio`,
      autoPlay: true,
    });
        ...
        <div className="flex flex-col gap-4 lg:flex-row lg:items-center lg:justify-between">
          <div className="min-w-0">
            ...
            <h3 className="text-xl sm:text-2xl font-bold text-slate-900 dark:text-white truncate">
              <span className="text-transparent bg-clip-text bg-gradient-to-r from-pink-500 via-orange-400 to-amber-500 dark:from-cyan-400 dark:via-blue-500 dark:to-violet-500 drop-shadow-sm">AI</span> {title || 'Flashcards'}
            </h3>
