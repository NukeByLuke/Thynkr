        ...
        <>
          ...
          <div className="absolute right-0 top-full mt-1 z-20 bg-white dark:bg-gray-800 rounded-xl shadow-lg border border-gray-200 dark:border-gray-700 py-2 min-w-[210px] overflow-hidden">
            <div className="px-2 pb-2">
              ...
              >
                <span className="pointer-events-none absolute inset-0 rounded-xl bg-gradient-to-r from-fuchsia-500 via-violet-500 to-cyan-500 opacity-95" />
                ...
                <span className="pointer-events-none absolute inset-0 rounded-xl bg-fuchsia-500/20 blur-md opacity-60 transition-opacity duration-300 group-hover:opacity-95 dark:bg-cyan-500/25" />
