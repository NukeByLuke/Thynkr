 ...
 * Thea-inspired OAuth buttons - both white with border, minimal rounding
 */
 ...
 * White background with border (Thea style - matches Google)
 */
  ...
  return (
    <div className="relative my-5">
      ...
      <div className="relative flex justify-center text-sm">
        <span className="px-4 font-medium bg-white dark:bg-[#1E293B] text-gray-400 dark:text-gray-500">or</span>
      </div>
    </div>
  );
}
