      ...
      {isOpen && (
        <>
          ...
          <motion.div
            ...
            animate={{ opacity: 1 }}
            exit={{ opacity: 0 }}
            className="fixed inset-0 bg-slate-900/70 backdrop-blur-xl z-50"
          ...
          <div className="fixed inset-0 flex items-center justify-center z-50 pointer-events-none">
            <motion.div
              ...
              className="relative bg-zinc-950/95 backdrop-blur-2xl rounded-3xl shadow-2xl border border-white/10 p-8 sm:p-12 max-w-md w-full mx-4 pointer-events-auto"
            >
              {/* Ambient glow effects */}
              <div className="absolute -top-20 -left-20 w-40 h-40 bg-cyan-500/20 rounded-full blur-3xl pointer-events-none" />
              <div className="absolute -bottom-20 -right-20 w-40 h-40 bg-violet-500/20 rounded-full blur-3xl pointer-events-none" />
