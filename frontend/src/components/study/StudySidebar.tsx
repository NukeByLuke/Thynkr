...
const StudySidebarComponent: React.FC<StudySidebarProps> = ({
  ...
  return (
    <aside
      className={`h-screen bg-white/80 dark:bg-slate-900/80 border-r border-slate-200/50 dark:border-slate-700/50 flex flex-col transition-all duration-300 ease-out ${
