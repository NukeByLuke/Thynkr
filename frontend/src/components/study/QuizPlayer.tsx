      ...
      <div className="bg-white rounded-lg shadow-lg p-4 sm:p-8 mb-4 sm:mb-6">
        <div className="prose prose-sm sm:prose-lg max-w-none mb-4 sm:mb-6">
          <ReactMarkdown
            ...
            components={{
              p: ({ node, ...props }) => <h4 className="text-base sm:text-xl font-semibold text-gray-900" {...props} />,
              strong: ({ node, ...props }) => <strong className="font-bold" {...props} />,
              code: ({ node, ...props }) => (
                <code className="bg-gray-100 text-indigo-600 px-1.5 sm:px-2 py-1 rounded text-sm sm:text-base font-mono" {...props} />
              ),
            }}
          >
              ...
              <div className="flex-1">
                ...
                <div className="prose prose-sm prose-blue max-w-none">
                  <ReactMarkdown
                    remarkPlugins={[remarkGfm]}
                    components={{
                      p: ({ node, ...props }) => <p className="text-blue-800 text-xs sm:text-sm" {...props} />,
                      strong: ({ node, ...props }) => <strong className="font-semibold text-blue-900" {...props} />,
                      code: ({ node, ...props }) => (
                        <code className="bg-blue-100 text-blue-900 px-1.5 py-0.5 rounded text-xs font-mono" {...props} />
                      ),
                    }}
                  >
