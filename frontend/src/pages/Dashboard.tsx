...
function DashboardSkeleton() {
  return (
    <div className="grid gap-4 md:gap-6 grid-cols-1 lg:grid-cols-3 auto-rows-fr">
      ...
      <div className="lg:col-span-2 bg-slate-900 border border-white/5 rounded-2xl p-8 animate-pulse">
        <div className="h-8 bg-slate-800 rounded w-2/3 mb-3" />
        <div className="h-5 bg-slate-800 rounded w-1/2" />
      </div>

      {/* Streak card skeleton */}
      <div className="bg-slate-900 border border-white/5 rounded-2xl p-6 animate-pulse">
      ...
      <div className="lg:col-span-3 bg-slate-900 border border-white/5 rounded-2xl p-6 animate-pulse">
        <div className="h-6 bg-slate-800 rounded w-48 mb-6" />
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid gap-4 md:gap-6 grid-cols-1 lg:grid-cols-3 auto-rows-fr">
          ...
          <motion.div
            ...
            className="lg:col-span-2 bg-slate-900 border border-white/5 rounded-2xl p-8 hover:border-white/10 transition-colors"
          >
          ...
          >
            <div className="flex items-center gap-4">
              ...
              <div>
                <div className="text-4xl font-bold text-white">{userStats.currentStreak}</div>
          ...
          <motion.div
            ...
            className="lg:col-span-3 bg-slate-900 border border-white/5 rounded-2xl p-6 hover:border-white/10 transition-colors"
          >
            <div className="flex items-center justify-between mb-4">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <div className="text-xl font-bold text-white">Level {userStats.currentLevel}</div>
                  <div className="text-sm text-slate-400">{userStats.currentXP} / {userStats.nextLevelXP} XP</div>
                </div>
              </div>
              <div className="text-right">
                <div className="text-2xl font-bold text-indigo-400">{Math.round(xpProgress)}%</div>
          ...
          <motion.button
            ...
            className="bg-slate-900 border border-white/5 rounded-2xl p-6 hover:border-blue-500/50 hover:bg-slate-800/50 transition-all text-left group"
          >
            <UploadCloud className="h-10 w-10 text-blue-400 mb-4 group-hover:scale-110 transition-transform" />
            <h3 className="text-lg font-semibold text-white mb-1">Upload Material</h3>
            <p className="text-sm text-slate-400">Add documents or PDFs</p>
          </motion.button>
          ...
          <motion.button
            ...
            className="bg-slate-900 border border-white/5 rounded-2xl p-6 hover:border-purple-500/50 hover:bg-slate-800/50 transition-all text-left group"
          >
            <Gamepad2 className="h-10 w-10 text-purple-400 mb-4 group-hover:scale-110 transition-transform" />
            <h3 className="text-lg font-semibold text-white mb-1">Start Quiz</h3>
          ...
          <motion.button
            ...
            className="bg-slate-900 border border-white/5 rounded-2xl p-6 hover:border-amber-500/50 hover:bg-slate-800/50 transition-all text-left group"
          >
            <BookOpen className="h-10 w-10 text-amber-400 mb-4 group-hover:scale-110 transition-transform" />
            <h3 className="text-lg font-semibold text-white mb-1">Browse Courses</h3>
            <p className="text-sm text-slate-400">Explore learning paths</p>
          </motion.button>
          ...
          >
            ...
            {!sessions || sessions.length === 0 ? (
              <div className="flex flex-col items-center justify-center py-12 text-center">
                ...
                <h3 className="text-lg font-semibold text-slate-400 mb-1">No recent activity</h3>
                <p className="text-sm text-slate-500">Start studying to see your activity here</p>
              </div>
            ) : (
              <div className="space-y-3">
                {sessions.map((session, index) => (
                  <motion.div
                    ...
                    className="group flex items-center gap-4 bg-slate-800/30 hover:bg-slate-800/60 border border-white/5 rounded-xl p-4 transition-all"
                  >
