    ...
    <>
      ...
      <div className="min-h-screen bg-gray-50 dark:bg-gray-900 py-12">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <h1 className="text-4xl font-bold text-gray-900 dark:text-white mb-8">Account Settings</h1>
        ...
        <div className="space-y-6">
          ...
          <Card>
            <div className="flex items-center gap-3 mb-6">
              ...
              <h2 className="text-2xl font-bold text-gray-900 dark:text-white">Membership & Subscription</h2>
            </div>
