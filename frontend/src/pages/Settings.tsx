...
import { User, Lock, Image, Moon, Sun, Trash2, Save, PencilLine, Globe } from 'lucide-react';
...
export default function Settings() {
  ...
  const handleProfileSubmit = async (e: React.FormEvent) => {
    ...
    if (username !== user?.username || avatarUrl !== user?.avatarUrl || preferredLanguage !== user?.preferredLanguage) {
  ...
  const handleThemeChange = (mode: 'light' | 'dark' | 'system') => {
    setThemeMode(mode);
    toast.success(`Theme set to ${mode === 'system' ? 'System preference' : mode === 'light' ? 'Light mode' : 'Dark mode'}`);
  };
  ...
  return (
    <>
      <Helmet>
        ...
        <meta name="description" content="Manage your Thynkr account settings, profile, and preferences" />
      </Helmet>

      <div key={user.id} className="min-h-screen bg-gray-50 dark:bg-gray-900 py-8">
            ...
            <div className="bg-white dark:bg-gray-800 rounded-lg shadow-sm p-6">
              ...
              <form onSubmit={handleProfileSubmit} className="space-y-4">
                  ...
                  <div className="flex items-center gap-4">
                      ...
                      {avatarPreview ? (
                        <img
                          ...
                          className={`w-20 h-20 rounded-full object-cover border-2 ${
                            avatarFile ? 'border-indigo-500 ring-2 ring-indigo-300' : 'border-gray-200 dark:border-gray-600'
                          }`}
                          onError={() => {
                    ...
                    <div>
                      ...
                      <p className="text-xs text-gray-500 dark:text-gray-400 mt-1">
                        PNG, JPG up to 2MB
                        {avatarFile && <span className="text-indigo-600 dark:text-indigo-400 font-medium"> • New image selected</span>}
                      </p>
                      <input
                        ref={fileInputRef}
                        type="file"
                ...
                <button
                  ...
                  className="px-6 py-2 bg-indigo-600 text-white rounded-lg hover:bg-indigo-700 dark:bg-indigo-500 dark:hover:bg-indigo-600 disabled:opacity-50 transition-colors flex items-center gap-2"
                >
            ...
            <div className="bg-white dark:bg-gray-800 rounded-lg shadow-sm p-6">
              ...
              <form onSubmit={handlePasswordSubmit} className="space-y-4">
                ...
                <button
                  ...
                  className="px-6 py-2 bg-indigo-600 text-white rounded-lg hover:bg-indigo-700 dark:bg-indigo-500 dark:hover:bg-indigo-600 disabled:opacity-50 transition-colors"
                >
                    ...
                    <label className="flex items-center gap-3 cursor-pointer group">
                      ...
                      <div className="flex items-center gap-2">
                        ...
                        <span className="text-gray-900 dark:text-white">
                          System {themeMode === 'system' && `(${theme === 'light' ? 'Light' : 'Dark'})`}
                        </span>
                      </div>
                    </label>
                  </div>
