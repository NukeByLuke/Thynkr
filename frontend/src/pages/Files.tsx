            ...
            >
              ...
              <div className="flex flex-col-reverse sm:flex-row gap-3 justify-end">
                ...
                <button
                  ...
                  className="px-6 py-2 bg-gradient-to-r from-pink-600 via-pink-500 to-orange-500 dark:from-cyan-500 dark:via-blue-600 dark:to-violet-600 hover:shadow-xl text-white rounded-lg transition-all duration-150 disabled:opacity-50 disabled:cursor-not-allowed font-medium active:scale-95 shadow-sm w-full sm:w-auto"
                >
