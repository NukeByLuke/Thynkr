      ...
      <>
        ...
        <div className="min-h-app flex items-center justify-center bg-slate-50 dark:bg-slate-950 p-4">
          <div className="text-center max-w-md">
            ...
            <button
              onClick={() => navigate(-1)}
              className="inline-flex w-full sm:w-auto items-center justify-center gap-2 px-5 py-2.5 bg-slate-900 dark:bg-white text-white dark:text-slate-900 rounded-[2px] font-medium hover:opacity-90 transition-opacity"
            >
                ...
                <div className="relative rounded-[2px] bg-white/88 dark:bg-slate-900/88 border-2 border-fuchsia-200 dark:border-cyan-500/25 overflow-hidden min-h-[54vh] sm:min-h-[60vh] backdrop-blur-sm">
                  ...
                  >
                    <div className="max-w-5xl mx-auto px-1.5 py-3 sm:px-6 sm:py-6 lg:px-8">
                      <div className="relative rounded-[2px] bg-white/60 dark:bg-slate-900/60 backdrop-blur-xl border border-slate-200/50 dark:border-slate-700/50 shadow-xl shadow-slate-200/20 dark:shadow-slate-900/30 overflow-hidden">
                          ...
                          {(activeTab === 'summary' || activeTab === 'notes') && studyContent.result.pages && studyContent.result.pages.length > 1 && (
                            <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3 sm:gap-0 mb-5 sm:mb-6 pb-4 border-b border-slate-200/60 dark:border-slate-700/60">
                              <button
                                ...
                                className="inline-flex w-full sm:w-auto items-center justify-center gap-1.5 px-3 py-2 text-sm font-medium rounded-[2px] transition-all disabled:opacity-30 disabled:cursor-not-allowed text-slate-600 dark:text-slate-300 hover:bg-slate-100 dark:hover:bg-slate-800 hover:text-pink-600 dark:hover:text-cyan-400"
                              >
