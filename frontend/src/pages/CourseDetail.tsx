    ...
    switch (activeTab) {
        ...
        return (
          <div className="text-center py-12">
            ...
            <div className="max-w-xs mx-auto mb-4">
              <label className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">Cards: {numCards}</label>
              <input
                type="range"
                min="10"
                max="50"
      ...
      case 'quizzes':
        if (selectedQuiz) {
          return (
            <div>
              <button onClick={() => setSelectedQuiz(null)} className="mb-4 text-indigo-600 dark:text-indigo-400 text-sm">
                ← Back
              </button>
              <QuizPlayer
            ...
            <div className="space-y-4">
              ...
              <div className="pt-4 border-t dark:border-gray-600 text-center">
                ...
                <div className="max-w-xs mx-auto space-y-4 mb-4">
                  <div>
                    <label className="block text-sm mb-2 text-gray-900 dark:text-white">Questions: {numQuestions}</label>
                    <input
                      type="range"
                      min="5"
                      max="20"
                ...
                <button
                  onClick={() => generateQuizMutation.mutate({ fileId: file.id, numQuestions, difficulty: quizDifficulty })}
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
            ...
            <div className="bg-white dark:bg-gray-800 rounded-lg shadow">
              <div className="p-4 border-b dark:border-gray-700">
                ...
                <p className="text-sm text-gray-500 dark:text-gray-400">{course.lessons.length} lessons</p>
              </div>
                  ...
                  >
                    <div className="flex items-start gap-3">
                      ...
                      <div className="flex-1 min-w-0">
                        ...
                        {lesson.file && (
                          <p className="text-xs text-gray-500 dark:text-gray-400 mt-1">{formatFileSize(lesson.file.fileSize)}</p>
                        )}
                      </div>
                    </div>
                  </button>
            ...
            <div className="lg:col-span-2">
              {!selectedLesson ? (
                <div className="bg-white dark:bg-gray-800 rounded-lg shadow p-12 text-center">
                  <h3 className="text-lg font-medium text-gray-900 dark:text-white">No lesson selected</h3>
                  <p className="text-sm text-gray-500 dark:text-gray-400 mt-2">Select a lesson to start studying</p>
                </div>
              ) : (
                <div className="bg-white dark:bg-gray-800 rounded-lg shadow">
                  <div className="p-6 border-b dark:border-gray-700">
                    ...
                    {selectedLesson.file && (
                      <p className="text-sm text-gray-500 dark:text-gray-400 mt-1">{selectedLesson.file.originalName}</p>
                    )}
                  </div>
